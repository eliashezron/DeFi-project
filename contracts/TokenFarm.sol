...
contract TokenFarm is Ownable {
    ...
    // the smart contract is to issue tokens to the stakers based on how muc they staked

    // 100 ETH 1:1 for every 1 ETH, we give 1 DappToken
    // 50 ETH and 50 DAI staked, and we are to give a reward of 1 DAPP / 1 DAI

    constructor(address _MyTokenAddress) public {
        dappToken = IERC20(_MyTokenAddress);
    }
    ...
    function unstakeTokens(address _token) public {
        ...
        // This is to solve the issue of stakers could appear twice
